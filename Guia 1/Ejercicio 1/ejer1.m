...
% [mean_training_error,epoca_ac,W]=Ps_training('../Datos/OR_trn.csv',3,1000,0.02,0,'EJER1 - OR');
% %Pruebo la neurona
...
%Entreno la neurona
[mean_training_error2,epoca_ac,W]=Ps_training('../Datos/XOR_trn.csv',3,200,0.03,0.26,'EJER1 - XOR');
