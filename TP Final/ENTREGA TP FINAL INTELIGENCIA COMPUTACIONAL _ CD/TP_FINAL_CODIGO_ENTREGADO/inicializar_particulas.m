...
function[particulas]=inicializar_particulas(intervalo1,intervalo2,cantParticulas,cantGauseanas)
    for i=1:cantParticulas
    particulas{i}=particula(intervalo1,intervalo2,cantGauseanas);
    end
...
function[part]=particula(intervalo1,intervalo2,cantParticulas)%cantidad de conj salida por cada particula
 ...
 %  p4= round(255*rand)
   ...
   p2_min=intervalo1(1);
   p2_max=intervalo1(2);
   p2=round(p2_min+rand(1,cantParticulas)*(p2_max-p2_min));
   
   p1_min=intervalo2(1);
   p1_max=intervalo2(2);
   p1=p1_min+rand(1,cantParticulas)*(p1_max-p1_min);
   
   p3_min=intervalo2(1);
   p3_max=intervalo2(2);
   p3=p1_min+rand(1,cantParticulas)*(p3_max-p1_min);
